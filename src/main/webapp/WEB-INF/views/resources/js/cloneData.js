        ...
        (function ($) {
            $.fn.cloneData = function (options, callback) {
              ...
              if (typeof callback === "function") {
                // make sure the after callback is a function
              ...
              var _updateAttributes = function () {
                ...
                $("#" + settings.mainContainerId + " ." + settings.cloneContainer).each(
                  function (parent_index, item) {
                  ...
                  function (parent_index, item) {
                    $(item)
                      ...
                      .each(function () {
                        $(this).attr(
                          "for",
                          $(this).attr("for").replace(/.$/, parent_index)
                        );
                      });
                ...
                $template.find("input, textarea, select").each(function () {
                  if ($(this).is(":checkbox") || $(this).is(":radio")) {
                    ...
                    $(this)
                      .parents(".fileinput")
                      .find(".previewing")
                      .attr("src", SITE_CONSTANT["DEFAULT_IMAGE_ADMIN"]);
                    $(this)
                      .parents(".fileinput")
                      .find(".fileinput-preview img")
                      .attr("src", SITE_CONSTANT["DEFAULT_IMAGE_ADMIN"]);
